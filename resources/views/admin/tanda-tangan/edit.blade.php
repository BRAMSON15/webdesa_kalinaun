    ...
    <div class="dashboard-main">
        ...
        <section class="dashboard-content">
            <div class="dashboard-header">
                <h1><i class="fas fa-pen-fancy me-2"></i>Edit Tanda Tangan Elektronik</h1>
            </div>
            @if ($errors->any())
            ...
            <div class="card">
                <div class="card-header">
                    <h5><i class="fas fa-pen-fancy"></i> Form Edit Tanda Tangan</h5>
                </div>
                <div class="card-body">
                    <form action="{{ route('admin.tanda-tangan.update', $tandaTangan->id) }}" method="POST" id="signatureForm">
                        @csrf
                        @method('PUT')
                        <div class="row">
                            <div class="col-md-6 mb-3">
                                <label class="form-label">Nama Penanda Tangan <span class="text-danger">*</span></label>
                                <input type="text" class="form-control @error('nama_penanda_tangan') is-invalid @enderror" name="nama_penanda_tangan" value="{{ old('nama_penanda_tangan', $tandaTangan->nama_penanda_tangan) }}" required>
                            ...
                            <div class="col-md-6 mb-3">
                                ...
                                <input type="text" class="form-control @error('jabatan') is-invalid @enderror" name="jabatan" value="{{ old('jabatan', $tandaTangan->jabatan) }}" required>
                                @error('jabatan')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>
                        ...
                        <div class="row">
                            <div class="col-md-6 mb-3">
                                ...
                                <input type="text" class="form-control @error('nip') is-invalid @enderror" name="nip" value="{{ old('nip', $tandaTangan->nip) }}">
                                @error('nip')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>
                            <div class="col-md-6 mb-3">
                                ...
                                <select class="form-select @error('signature_type') is-invalid @enderror" name="signature_type" id="signatureType" required onchange="toggleSignatureInput()">
                                    ...
                                    <option value="digital" {{ old('signature_type', $tandaTangan->signature_type) === 'digital' ? 'selected' : '' }}>Digital (Gambar Tangan)</option>
                                    <option value="scanned" {{ old('signature_type', $tandaTangan->signature_type) === 'scanned' ? 'selected' : '' }}>Scan (Upload File)</option>
                                </select>
                        ...
                        <div class="current-signature">
                            ...
                            <img src="{{ $tandaTangan->signature_image }}" class="signature-preview" alt="Tanda Tangan">
                        </div>
                        <!-- Digital Signature Input -->
                        <div id="digitalSignatureInput" style="display: none;">
                            <div class="mb-3">
                                <label class="form-label">Gambar Tanda Tangan Baru (Opsional)</label>
                                <p class="text-muted small">Silakan gambar tanda tangan baru Anda di area di bawah ini jika ingin mengubah</p>
                                ...
                                <input type="hidden" id="signatureImage" name="signature_image" value="">
                        ...
                        <div id="scannedSignatureInput" style="display: none;">
                            <div class="mb-3">
                                <label class="form-label">Upload File Tanda Tangan Baru (Opsional)</label>
                        ...
                        <div class="row">
                            <div class="col-md-6 mb-3">
                                ...
                                <input type="date" class="form-control @error('berlaku_dari') is-invalid @enderror" name="berlaku_dari" value="{{ old('berlaku_dari', $tandaTangan->berlaku_dari?->format('Y-m-d')) }}">
                                @error('berlaku_dari')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>
                            <div class="col-md-6 mb-3">
                                ...
                                <input type="date" class="form-control @error('berlaku_sampai') is-invalid @enderror" name="berlaku_sampai" value="{{ old('berlaku_sampai', $tandaTangan->berlaku_sampai?->format('Y-m-d')) }}">
                        ...
                        <div class="mb-3">
                            <div class="form-check">
                                <input class="form-check-input" type="checkbox" name="is_active" id="isActive" {{ $tandaTangan->is_active ? 'checked' : '' }}>
...
document.getElementById('signatureForm').addEventListener('submit', function(e) {
    const type = document.getElementById('signatureType').value;
    if (type === 'digital' && !signaturePad.isEmpty()) {
