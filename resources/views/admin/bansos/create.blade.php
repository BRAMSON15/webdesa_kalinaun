...
<link rel="stylesheet" href="{{ asset('css/bansos.css') }}">
<div class="wrapper">
    ...
    <div class="dashboard-main">
        ...
        <section class="dashboard-content">
            <div class="dashboard-header">
                <h1><i class="fas fa-plus-circle me-2"></i>Tambah Program Bansos</h1>
            </div>
            @if ($errors->any())
            ...
            <div class="card">
                <div class="card-header">
                    <h5><i class="fas fa-file-alt"></i> Form Tambah Program Bansos</h5>
                </div>
                <div class="card-body">
                    <form action="{{ route('admin.bansos.store') }}" method="POST" id="formBansos">
                        @csrf
                        <!-- Informasi Dasar -->
                        ...
                        <div class="form-section">
                            ...
                            <div class="mb-3">
                                ...
                                <textarea class="form-control @error('deskripsi') is-invalid @enderror" 
                                          ...
                                          rows="4" 
                                          required
                                          placeholder="Masukkan deskripsi program bansos...">{{ old('deskripsi') }}</textarea>
                            ...
                            <div class="mb-3">
                                ...
                                <textarea class="form-control @error('syarat_ketentuan') is-invalid @enderror" 
                                          ...
                                          rows="4"
                                          placeholder="Masukkan syarat dan ketentuan program...">{{ old('syarat_ketentuan') }}</textarea>
